        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    analyzer = new DebugBabelAnalyzer_1.DebugBabelAnalyzer();
                ...
                case 1:
                    ...
                    issues.forEach(function (issue, index) {
                        console.log("\n".concat(index + 1, ". ").concat(issue.title));
                        console.log("   File: ".concat(issue.file));
                        console.log("   Severity: ".concat(issue.severity));
                        console.log("   Description: ".concat(issue.message));
                        console.log("   Suggestion: ".concat(issue.suggestion));
                    });
                    return [2 /*return*/];
            }
        });
