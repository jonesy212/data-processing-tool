...
import { AnimationType, useAnimationHook } from '@/app/libraries/animations/AnimationLibrary';
import { useShakeAnimation } from '@/app/libraries/animations/useShakeAnimation';
