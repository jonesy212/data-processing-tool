...
import { BaseEntity } from '@/components/routing/FuzzyMatch';
...
> extends Partial<SharedIdentifiers<T, K, Meta, AttachmentType, ExcludedFields>>,
          ...
          Partial<SnapshotBase<T, K, Meta, AttachmentType, ExcludedFields>>,
          Partial<SharedTimestamps>
{
  ...
  metadata?: UnifiedMetadata<T, K, Meta, AttachmentType, ExcludedFields>;
  ...
  phase?: Phase<PhaseData<T>, PhaseData<K>> | null;
  ownerId?: string;
