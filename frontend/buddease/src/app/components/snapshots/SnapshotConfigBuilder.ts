...
import { EventStore } from "../../../data_analysis/frontend/buddease/src/app/components/event/EventStore";
...
> extends SnapshotInstanceProps<Params[0], Params[1], Params[2], Params[3]> {
  data: InitializedData<Params[0], Params[1], Params[2], Params[3]>;
  fetchData: () => Promise<SnapshotStoreConfig<Params[0], Params[1], Params[2], Params[3]>>;
}
