...
> extends BaseEntity {
  ...
  snapshot?: Snapshot<T, K, Meta, ExcludedFields>; // Optional snapshot
...
> extends SnapshotCommonProps<T, K, Meta, ExcludedFields> {
  ...
  snapshotStoreConfigData: SnapshotStoreConfig<T, K, Meta, ExcludedFields>; // Replace `any` with the appropriate type
