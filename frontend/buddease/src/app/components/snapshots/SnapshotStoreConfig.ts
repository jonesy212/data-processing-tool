...
// import {  MultipleEventsCallbacks } from '../snapshots/index';
...
// interface UserConfig<T extends  BaseData<T>, K extends T = T, Meta extends StructuredMetadata<T, K> = StructuredMetadata<T, K>> extends ViteUserConfig {
//   snapshotConfig?: SnapshotConfig<T, K>[]; // Use generic types
//   snapshotStoreConfig?: SnapshotStoreConfig<T, K>[]; // Use generic types
// }

// interface DataWithParentAndChildIds<T, Meta = any, 
// K extends T = T> extends BaseData<T, K> {
//   parentId?: string;
//   childIds?: string[];
// }

// export interface SnapshotStoreConfig<T extends  BaseData<T>, K extends T = T, Meta extends StructuredMetadata<T, K> = StructuredMetadata<T, K>> 
//   extends SnapshotStoreOptions<T, K>,
//   SnapshotConfiguration<T, K>, 
//   SnapshotErrorHandling<T, K>,
//   SnapshotSubscriberManagement<T, K>{
...
//       SnapshotWithCriteria<any, BaseData<T, K, T>>
//       >
//   ) => Snapshot<T, K> | null;
...
//   getData: (data: Snapshot<T, K> | Snapshot<T, Data<CustomSnapshotData<T>>>) => Promise<{
//     data: Snapshot<T, K>;
//   }>;
...
// const snapshotStoreConfig: SnapshotStoreConfig<T, K<T>> | null = null; // Or populate as needed
        
// type InitializedConfig = SnapshotStoreConfig< BaseData<T>,  BaseData<T>> | SnapshotConfig< BaseData<T>,  BaseData<T>> | null


// // A safe casting function to ensure type compatibility
// function safeCastSnapshotStore <T extends  BaseData<T>, K extends T = T, Meta extends StructuredMetadata<T, K> = StructuredMetadata<T, K>>(
//   snapshotStore: SnapshotStore<T, K>,
//   context: {
//     useSimulatedDataSource: boolean;
//     simulatedDataSource: SnapshotStoreConfig<T, K>[];
//   }
// ): SnapshotStore<SnapshotUnion<BaseData, Meta>, K> {
...
//         throw new Error("No delegates available.");
//       }
//       return simulatedDataSource as unknown as SnapshotStoreConfig<SnapshotUnion<BaseData, Meta>, K>
//     },

//     // Transformation function for initializing the state of the snapshot store
//     transformInitialState: <U extends Data<U>, T extends U = U>(
...
//         category: Category | undefined,
//         categoryProperties: CategoryProperties | undefined,
//         dataStoreMethods: DataStore<SnapshotUnion<BaseData, Meta>,BaseData>
...
//             throw new Error("Function not implemented.");
//           },
//           defaultSubscribeToSnapshots: function (snapshotId: string, callback: (snapshots: Snapshots<T>) => Subscriber<BaseData, BaseData> | null, snapshot: Snapshot<BaseData, BaseData> | null): void {
//             throw new Error("Function not implemented.");
//           },
...
//             event: Event, 
//             id: number, 
//             snapshotStore: SnapshotStore<BaseData, BaseData>, category: symbol | string | Category | undefined, categoryProperties: CategoryProperties | undefined, dataStoreMethods: DataStore<BaseData, BaseData>, data: T, dataCallback?: ((subscribers: Subscriber<BaseData, BaseData>[], snapshots: Snapshots<T>) => Promise<Snapshots<T>>) | undefined): Promise<Snapshot<BaseData, BaseData>[]> {
//             throw new Error("Function not implemented.");
//           },
...
//           getAllKeys: function (storeId: number, snapshotId: string, category: symbol | string | Category | undefined, snapshot: Snapshot<BaseData, BaseData>, timestamp: string | number | Date | undefined, type: string, event: Event, id: number, snapshotStore: SnapshotStore<BaseData, BaseData>, data: T): Promise<string[] | undefined> {
//             throw new Error("Function not implemented.");
//           },
...
//             throw new Error("Function not implemented.");
//           },
//           getSnapshot: function (snapshot: (id: string) => Promise<{ snapshotId: number; snapshotData: T; category: Category | undefined; categoryProperties: CategoryProperties; dataStoreMethods: DataStore<BaseData, BaseData>; timestamp: string | number | Date | undefined; id: string | number | undefined; snapshot: Snapshot<BaseData, BaseData>; snapshotStore: SnapshotStore<BaseData, BaseData>; data: T; }> | undefined): Promise<Snapshot<BaseData, BaseData> | undefined> {
//             throw new Error("Function not implemented.");
//           },
...
//             throw new Error("Function not implemented.");
//           },
//           getDataStoreMap: function (): Promise<Map<string, Snapshot<BaseData, BaseData>>> {
//             throw new Error("Function not implemented.");
//           },
...
//             snapshot: Snapshot<BaseData, BaseData>, snapshotId: number, snapshotData: T, category: Category | undefined, callback: (snapshot: T) => void, snapshots: SnapshotsArray<T>,
...
//         // Convert snapshotConfig into the correct type (Snapshot<SnapshotUnion<BaseData, Meta>, K>)
//         const fullyConfiguredSnapshot: Snapshot<SnapshotUnion<BaseData, Meta>, K> = {
//           ...snapshotConfig,
...
//         const snapshotStore: SnapshotStore< BaseData<T>, BaseData> = {
//           id: id,
//           key: key,
//           keys: keys,
//           config: storeConfig,
...
//             subscribers: SubscriberCollection<T, K>,
//             snapshotContainer?: SnapshotUnion<BaseData, Meta> | undefined,
//             snapshotStoreConfig?: SnapshotStoreConfig<SnapshotUnion<BaseData, Meta>, K> | undefined): void {
//             throw new Error("Function not implemented.");
//           },
...
//             sub: Subscriber<BaseData, BaseData>): Subscriber<BaseData, T> {
//             throw new Error("Function not implemented.");
//           },
//           getAllKeys: function (
//             storeId: number, 
...
//             throw new Error("Function not implemented.");
//           },
//           getSnapshotSuccess: function (snapshot: Snapshot<SnapshotUnion<BaseData, Meta>, T>, subscribers: Subscriber<T, K>[]): Promise<SnapshotStore<SnapshotUnion<BaseData, Meta>, T>> {
//             throw new Error("Function not implemented.");
//           },
...
//     createSnapshotStore:  <T extends  BaseData<T>, K extends T = T, Meta extends StructuredMetadata<T, K> = StructuredMetadata<T, K>>(
//       id: string,
//       storeId: number,
//       snapshotId: string,
//       snapshotStoreData: SnapshotStore<T, K>[],
...
// export { snapshotStoreConfig, snapshotStoreConfigs }
// export type {UserConfig, InitializedConfig }
