...
interface SnapshotStoreDataResponse<T extends  BaseData<T>, K extends T = T, Meta extends StructuredMetadata<T, K> = StructuredMetadata<T, K>> extends SnapshotDataResponse<T, K> {
  id: string | number;
  timestamp: Date;
  category: string;
  topic?: string;
