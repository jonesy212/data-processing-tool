...
import { CoreSnapshot } from '@/app/components/snapshots';
...
import {  createSnapshotConfig } from './SnapshotConfig';
...
import { SnapshotEventBase } from './SnapshotEventBase'
...
import { createDataStore } from '@/app/components/projects/DataAnalysisPhase/DataProcessing/DataStore';
import { ExcludedFields } from '@/app/components/routing/Fields';
import { BaseDataEntity } from '@/app/configs/BaseConfig';
import { BaseEntityProperties, SharedSnapshotProperties, SharedIdentifiers } from '../../../data_analysis/frontend/buddease/src/app/components/documents/RelatedProps';
import { DefaultMeta, DefaultExcludedFields } from '@/configs/BaseConfig';
...
import { useDataStore } from '../../../data_analysis/frontend/buddease/src/app/components/projects/DataAnalysisPhase/DataProcessing/DataStore';
...
>(
  ...
  return (
    ...
    "timestamp" in obj &&       // optional but safer
    "isCore" in obj             // optional but safer
  );
}
...
> = {
  ...
  options: {
    ...
    configureSnapshot: (
      ...
      const newSnapshot: Snapshot<T, K, Meta, AttachmentType, ExcludedFields, IncludedFields> = createSnapshotInstance(
        baseData, 
        baseMeta, 
        snapshotId, 
