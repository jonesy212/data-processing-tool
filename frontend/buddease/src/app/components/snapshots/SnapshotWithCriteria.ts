...
//     private config: SnapshotStoreConfig<SnapshotUnion<T>, K>;
...
//             return {
//                 onEventClick: (event: CalendarEvent<Data, Data>) => {
//                     console.log("onEventClick", event);
//                 },
//                 onEventDoubleClick: (event: CalendarEvent<Data, Data>) => {
//                     console.log("onEventDoubleClick", event);
//                 },
//                 onEventContextMenu: (event: CalendarEvent<Data, Data>) => {
//                     console.log("onEventContextMenu", event);
//                 },
//                 onEventDrop: (event: CalendarEvent<Data, Data>) => {
//                     console.log("onEventDrop", event);
//                 },
//                 onEventResize: (event: CalendarEvent<Data, Data>) => {
//                     console.log("onEventResize", event);
//                 },
//                 onEventSelect: (event: CalendarEvent<Data, Data>) => {
//                     console.log("onEventSelect", event);
//                 },
//                 onEventDeselect: (event: CalendarEvent<Data, Data>) => {
//                     console.log("onEventDeselect", event);
//                 },
//                 onEventCreate: (event: CalendarEvent<Data, Data>) => {
//                     console.log("onEventCreate", event);
//                 },
//                 onEventRemove: (event: CalendarEvent<Data, Data>) => {
//                     console.log("onEventRemove", event);
//                 },
//                 onEventReceive: (event: CalendarEvent<Data, Data>) => {
