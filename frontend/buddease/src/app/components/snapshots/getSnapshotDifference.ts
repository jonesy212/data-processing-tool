...
function getSnapshotDifference<T extends BaseDataEntity, K extends T = T, Meta extends DefaultMeta<T, K> = DefaultMeta<T, K>>(snapshot1: Snapshot<T, K, Meta, ExcludedFields>, snapshot2: Snapshot<T, K, Meta, ExcludedFields>): number {
