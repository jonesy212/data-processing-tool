...
import { UnifiedMetadata } from '../../../../data_analysis/frontend/buddease/src/app/configs/database/MetaDataOptions';
import { CategoryProperties } from '../../../../data_analysis/frontend/buddease/src/app/pages/personas/ScenarioBuilder';
import { createSnapshot } from '../createSnapshot';
import { T, K, Meta } from '../../../../data_analysis/frontend/buddease/src/app/components/models/data/dataStoreMethods';
...
export const SnapshotMethodsImplementation = {
  ...
  >(
    ...
    try {
      ...
      const snapshotInstance = await createSnapshot<T, K, Meta, ExcludedFields>(
  ...
  >(
    this: SnapshotStore<T, K, Meta, ExcludedFields>,
    snapshotToRemove: Snapshot<T, K, Meta, ExcludedFields>
  ): void {
    try {
      // Validate input
  ...
  >(
    this: SnapshotStore<T, K, Meta, ExcludedFields>,
    snapshotId: string,
    newData: Partial<Snapshot<T, K, Meta, ExcludedFields>>
  ): Promise<{ snapshot: Snapshot<T, K, Meta, ExcludedFields> }> {
  ...
  >(
    ...
    // Use the type guard to check if snapshotData is of type Snapshot<T, K, Meta, ExcludedFields>
