...
import { SnapshotCoreBase } from '@/app/components/snapshots';
import { Data } from "../../../../data_analysis/frontend/buddease/src/app/components/models/data/Data";
import { ExcludedFields } from "../../../../data_analysis/frontend/buddease/src/app/components/routing/Fields";
import SnapshotStore from "../../../../data_analysis/frontend/buddease/src/app/components/snapshots/SnapshotStore";
...
> extends SnapshotStoreConfig<T, K, Meta, ExcludedFields>, SnapshotCoreBase<T, K, Meta, ExcludedFields> {}
// -------------------------------
...
export const TransformMethods = {
  ...
  >(
    this: SnapshotStore<T, K, Meta, ExcludedFields>,
    option: Partial<SnapshotStoreConfig<T, K, Meta, ExcludedFields>> | string | null | undefined
