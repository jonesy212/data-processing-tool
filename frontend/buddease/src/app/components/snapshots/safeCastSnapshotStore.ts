...
import { InitializedState } from "../../../data_analysis/frontend/buddease/src/app/components/projects/DataAnalysisPhase/DataProcessing/DataStore";
...
import { SchemaField } from "../../../data_analysis/frontend/buddease/src/server/database/SchemaField";
...
>(
  ...
  return {
    ...
    transformSnapshot: (snapshot: Snapshot<T, K, Meta, ExcludedFields>): Snapshot<T, K, Meta, ExcludedFields> => {
