...
// const snapshotStore = new SnapshotStore<Snapshot<Data>, Data>(
//   notify,
//   initSnapshot,
//   snapshotConfig,
//   {} as Data
...
//   snapshotConfig: SnapshotStoreConfig<SnapshotStore<Snapshot<T>, DataT>, DataT>
...
//           const adaptedSnapshot: Snapshot<T> = adaptSnapshot<T>(snapshot);

//           // 1. Send Notifications
//           await dispatch(
//             useSnapshotSlice.actions.sendNotification({
//               snapshot: adaptedSnapshot as WritableDraft<Snapshot<T>>,
//               subscriber,
//             })
//           );
