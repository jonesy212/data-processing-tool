...
// interface SnapshotStorageOptions<T extends  BaseData<T>, K extends T = T, Meta extends StructuredMetadata<T, K> = StructuredMetadata<T, K>> {
// 	baseURL: string;
// 	enabled: boolean;
// 	maxRetries: number;
// 	retryDelay: number;
...
// interface SnapshotConfigOptions<T extends  BaseData<T>, K extends T = T, Meta extends StructuredMetadata<T, K> = StructuredMetadata<T, K>> {
// 	id: string;
// 	snapshotId: number;
...
// 		snapshot: function (id: string | number | undefined, snapshotId: number, snapshotData: SnapshotData<Data, BaseData>, category: symbol | string | Category | undefined, categoryProperties: CategoryProperties | undefined, dataStoreMethods: DataStore<Data, BaseData>[]): Snapshot<Data, BaseData> | Promise<{ snapshot: Snapshot<Data, BaseData>; }> {
