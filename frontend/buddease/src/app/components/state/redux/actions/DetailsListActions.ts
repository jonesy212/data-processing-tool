...
export const DetailsListActions = {
  ...
  createDetailsItemSuccess: createAction<{ detailsItem: DetailsItem }>(`${PREFIX}/createDetailsItemSuccess`),
  ...
  updateDetailsItemSuccess: createAction<{ detailsItemId: string, detailsItem: DetailsItem }>(`${PREFIX}/updateDetailsItemSuccess`),
  ...
  fetchDetailsItemSuccess: createAction<{ detailsItem: DetailsItem }>(`${PREFIX}/fetchDetailsItemSuccess`),
  ...
  fetchDetailsItemsSuccess: createAction<{ detailsItems: DetailsItem[] }>(`${PREFIX}/fetchDetailsItemsSuccess`),
  ...
  updateDetailsItemsSuccess: createAction<{ detailsItems: DetailsItem[] }>(`${PREFIX}/updateDetailsItemsSuccess`),
