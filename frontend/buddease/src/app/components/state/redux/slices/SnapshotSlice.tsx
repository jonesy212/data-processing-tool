...
import { Callback, notifySubscribers, snapshot, SnapshotConfig, SnapshotData, SnapshotWithCriteria } from "@/app/components/snapshots";
...
export const fetchDataStores = createAsyncThunk(
  ...
  async (context: { useSimulatedDataSource: boolean; simulatedDataSource: SnapshotStoreConfig<T, K, Meta, ExcludedFields>[] }) => {
...
const useSnapshotSlice = createSlice({
  ...
  reducers: {
    addSnapshot: (
      state,
      action: PayloadActionWithMeta<Snapshot<T, K, Meta, ExcludedFields>>
    ) => {
    ...
    clearSnapshot: (state, action: PayloadAction<string>) => {
      ...
      if (snapshotToRemove) {
        snapshotToRemove.data = {} as Map<string, WritableDraft<Snapshot<T, K, Meta, ExcludedFields>>>
      }
    },
    ...
    batchFetchSnapshotsRequest: (
      ...
      const notifySubscribers = async <T extends  BaseData<any>, K extends T = T, Meta extends StructuredMetadata<T, K> = StructuredMetadata<T, K>>(
        subscribers: Subscriber<T, K, Meta, ExcludedFields>[],
        action: PayloadAction<{ snapshot: Snapshot<T, K, Meta, ExcludedFields>; subscriber: Subscriber<T, K, Meta, ExcludedFields> }>
      ) => {
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(fetchDataStores.fulfilled, (state, action: PayloadAction<DataStore<T, K, Meta, ExcludedFields>[]>) => {
        state.loading = false;
...
>(): Snapshot<T, K, Meta, Attachment, ExcludedFields, any> => {
  ...
  return {
    ...
    key: "value",
    topic: "topic",
    configOption: {} as string | WritableDraft<SnapshotStoreConfig<T, K, Meta, ExcludedFields>> | string,
    config: {} as Promise<SnapshotStoreConfig<T, K, Meta, ExcludedField> | null>,
    subscription: {} as WritableDraft<Subscription<T, K, Meta, ExcludedFields>>,
    initialState: {} as WritableDraft<SnapshotStoreConfig<T, K, Meta, ExcludedFields>>,
    category: "category",
    store: "",
    timestamp: new Date(),
    ...
    getDataVersions: function (id: number): Promise<Snapshot<T, K, Meta, ExcludedFields>[] | undefined> {
      throw new Error("Function not implemented.");
    },
    updateDataVersions: function (id: number, versions: Snapshot<T, K, Meta, ExcludedFields>[]): void {
      throw new Error("Function not implemented.");
    },
    ...
    getSnapshot: function (snapshot: (id: string) => Promise<{ category: any; timestamp: any; id: any; snapshot: Snapshot<T, K, Meta, ExcludedFields>; snapshotStore: SnapshotStore<BaseData, BaseData>; data: BaseData; }> | undefined): Promise<Snapshot<T, K, Meta, ExcludedFields>> {
      throw new Error("Function not implemented.");
    },
    getSnapshotSuccess: function (snapshot: Snapshot<T, K, Meta, ExcludedFields>): Promise<SnapshotStore<BaseData, BaseData>> {
      throw new Error("Function not implemented.");
    },
    setItem: function (key: BaseData<any, any, any>, value: BaseData<any, any, any>): Promise<void> {
      throw new Error("Function not implemented.");
    },
    getDataStore: (): Promise<DataStore<T, K, Meta, ExcludedFields>[]> =>{
      throw new Error("Function not implemented.")
    },
    getDataStoreMap: (): Promise<Map<string, DataStore<T, K, Meta, ExcludedFields>>> => {
      return Promise.resolve(new Map<string, DataStore<T, K, Meta, ExcludedFields>>());
    },
    ...
    addSnapshotItem: function (item: Snapshot<T, K, Meta, ExcludedFields>| SnapshotStoreConfig<T, K, Meta, ExcludedFields>): void {
      throw new Error("Function not implemented.");
    },
    ...
    initSnapshot: function (
      snapshot: SnapshotStore<BaseData, BaseData> | Snapshot<T, K, Meta, ExcludedFields> | null,
    ...
    validateSnapshot: function (snapshotId: string, snapshot: Snapshot<T, K, Meta, ExcludedFields>): boolean {
      throw new Error("Function not implemented.");
    },
    ...
    reduceSnapshots: function <U>(callback: (acc: U, snapshot: Snapshot<T, K, Meta, ExcludedFields>) => U, initialValue: U): U | undefined {
      throw new Error("Function not implemented.");
    },
    ...
    notifySubscribers: function (message: string, subscribers: Subscriber<T, K, Meta, ExcludedFields>[], data: Partial<SnapshotStoreConfig<BaseData, any>>): Subscriber<T, K, Meta, ExcludedFields>[] {
      throw new Error("Function not implemented.");
    },
    getSnapshots: function (category: string, data: Snapshots<BaseData>): void {
      throw new Error("Function not implemented.");
    },
    getAllSnapshots: function (data: (subscribers: Subscriber<T, K, Meta, ExcludedFields>[], snapshots: Snapshots<BaseData>) => Promise<Snapshots<BaseData>>): void {
      throw new Error("Function not implemented.");
    },
    ...
    ): Promise<{ subscribers: Subscriber<T, K, Meta, ExcludedFields>[]; snapshots: Snapshots<BaseData>; }> {
      throw new Error("Function not implemented.");
    },
    ...
    batchFetchSnapshotsSuccess: function (subscribers: Subscriber<T, K, Meta, ExcludedFields>[], snapshots: Snapshots<BaseData>): void {
      throw new Error("Function not implemented.");
    },
    ...
    batchUpdateSnapshotsSuccess: function (subscribers: Subscriber<T, K, Meta, ExcludedFields>[], snapshots: Snapshots<BaseData>): void {
      throw new Error("Function not implemented.");
    },
    ...
    handleSnapshotSuccess: function (message: string, snapshot: Snapshot<T, K, Meta, ExcludedFields> | null, snapshotId: string): void {
      throw new Error("Function not implemented.");
    },
    getSnapshotId: function (key: string | SnapshotData<T, K, Meta, ExcludedFields>): unknown {
      throw new Error("Function not implemented.");
    },
    compareSnapshotState: function (snapshot1: Snapshot<T, K, Meta, ExcludedFields> | null, state: any): boolean {
      throw new Error("Function not implemented.");
    },
    eventRecords: null,
    snapshotStore: null,
    ...
    getChildIds: function (childSnapshot: Snapshot<T, K, Meta, ExcludedFields>): void {
      throw new Error("Function not implemented.");
    },
    ...
    isDescendantOf: function (snapshot: Snapshot<T, K, Meta, ExcludedFields>, childSnapshot: Snapshot<T, K, Meta, ExcludedFields>): boolean {
      throw new Error("Function not implemented.");
    },
    dataItems: null,
    newData: null,
    ...
    getConfigOption: function (): SnapshotStoreConfig<T, K, Meta, ExcludedFields> | null {
      throw new Error("Function not implemented.");
    },
    ...
    getData: function (): BaseData | Map<string, Snapshot<T, K, Meta, ExcludedFields>> | null | undefined {
      throw new Error("Function not implemented.");
    },
    ...
    mapSnapshot: function (storeId: number, snapshotStore: SnapshotStore<BaseData, BaseData>, snapshotId: string, snapshot: Snapshot<T, K, Meta, ExcludedFields>, type: string, event: Event): Promise<string | undefined> | null {
      throw new Error("Function not implemented.");
    },
    mapSnapshots: function (storeIds: number[], snapshotId: string, snapshot: Snapshot<T, K, Meta, ExcludedFields>, type: string, event: Event): void | null {
      throw new Error("Function not implemented.");
    },
    removeStore: function (storeId: number, store: SnapshotStore<BaseData, BaseData>, snapshotId: string, snapshot: Snapshot<T, K, Meta, ExcludedFields>, type: string, event: Event): void | null {
      throw new Error("Function not implemented.");
    },
    ...
    addSnapshotFailure: function (snapshotManager: SnapshotManager<BaseData, BaseData>, snapshot: Snapshot<T, K, Meta, ExcludedFields>, payload: { error: Error; }): void {
      throw new Error("Function not implemented.");
    },
    configureSnapshotStore: function (snapshotStore: SnapshotStore<BaseData, BaseData>, snapshotId: string, data: Map<string, Snapshot<T, K, Meta, ExcludedFields>>, events: Record<string, CalendarEvent<BaseData, BaseData>[]>, dataItems: RealtimeDataItem[], newData: Snapshot<T, K, Meta, ExcludedFields>, payload: ConfigureSnapshotStorePayload<BaseData>, store: SnapshotStore<any, BaseData>, callback: (snapshotStore: SnapshotStore<BaseData, BaseData>) => void): void | null {
      throw new Error("Function not implemented.");
    },
    updateSnapshotSuccess: function (snapshotId: string, snapshotManager: SnapshotManager<BaseData, BaseData>, snapshot: Snapshot<T, K, Meta, ExcludedFields>, payload: { error: Error; }): void | null {
      throw new Error("Function not implemented.");
    },
    createSnapshotFailure: function (snapshotId: string, snapshotManager: SnapshotManager<BaseData, BaseData>, snapshot: Snapshot<T, K, Meta, ExcludedFields>, payload: { error: Error; }): Promise<void> {
      throw new Error("Function not implemented.");
    },
    createSnapshotSuccess: function (snapshotId: string, snapshotManager: SnapshotManager<BaseData, BaseData>, snapshot: Snapshot<T, K, Meta, ExcludedFields>, payload: { error: Error; }): void | null {
      throw new Error("Function not implemented.");
    },
    createSnapshots: function (id: string, snapshotId: string, snapshot: Snapshot<T, K, Meta, ExcludedFields>, snapshotManager: SnapshotManager<BaseData, BaseData>, payload: CreateSnapshotsPayload<BaseData, BaseData>, callback: (snapshots: Snapshot<T, K, Meta, ExcludedFields>[]) => void | null, snapshotDataConfig?: SnapshotConfig<BaseData, BaseData>[] | undefined, category?: string | symbol | Category): Snapshot<T, K, Meta, ExcludedFields>[] | null {
      throw new Error("Function not implemented.");
    },
    onSnapshot: function (snapshotId: string, snapshot: Snapshot<T, K, Meta, ExcludedFields>, type: string, event: Event, callback: (snapshot: Snapshot<T, K, Meta, ExcludedFields>) => void): void {
      throw new Error("Function not implemented.");
    },
    ...
    label: undefined,
    events: undefined,
    handleSnapshot: function (id: string, snapshotId: string, snapshot: BaseData | null, snapshotData: BaseData, category: symbol | string | Category | undefined, callback: (snapshot: BaseData) => void, snapshots: Snapshots<Data>, type: string, event: Event, snapshotContainer?: BaseData | undefined, snapshotStoreConfig?: SnapshotStoreConfig<T, K, Meta, ExcludedFields> | undefined): Promise<Snapshot<T, K, Meta, ExcludedFields> | null> {
      throw new Error("Function not implemented.");
    },
    subscribeToSnapshots: function (snapshotId: string, unsubscribeType: string, unsubscribeDate: Date, unsubscribeReason: string, unsubscribeData: any, callback: (snapshots: Snapshots<BaseData>) => Snapshot<T, K, Meta, ExcludedFields> | null): void {
      throw new Error("Function not implemented.");
    },
    meta: undefined,
    subscribers: []
...
async function fetchRealDataSource(): Promise<SnapshotStoreConfig<T, K, Meta, ExcludedFields>[]> {
...
function initializeDataStore(config: SnapshotStoreConfig<T, K, Meta, ExcludedFields>): DataStore<T, K, Meta, ExcludedFields> {
