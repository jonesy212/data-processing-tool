...
const NOTIFICATION_MESSAGES = {
  ...
  Details: {
    ...
    UPDATE_DETAILS_ITEMS_ERROR:
      "Error updating details items. Please try again",
    DELETE_DETAILS_ITEMS_SUCCESS: "Details items deleted successfully",
    DELETE_DETAILS_ITEMS_ERROR:
      "Error deleting details items. Please try again",
  ...
  Video: {
    ...
    SEND_VIDEO_NOTIFICATION_ERROR:
      "Error sending video notification. Please try again",
    ...
    UPDATE_VIDEO_METADATA_ERROR:
      "Error updating video metadata. Please try again",
  ...
  TokenUtils: {
    ...
    // Auth
    ERROR_GENERATING_TRANSFER_TOKEN:
      "Error generating transfer token. Please try again",
