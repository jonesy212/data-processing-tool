...
const baseConfig: BaseConfig<T, K<T>> = {
  ...
  mappedSnapshot: new Map<string, Snapshot<T, K<T>, StructuredMetadata<T, K<T>>>>(), // Initialize meta as a new Map
  meta: {} as StructuredMetadata<T, K<T>>, // Initialize meta as a new Map
  events: {
     eventRecords: {},
  },
}
