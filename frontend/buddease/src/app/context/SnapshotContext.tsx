...
// interface SnapshotContextType<T extends  BaseData<T>, K extends T = T, Meta extends StructuredMetadata<T, K> = StructuredMetadata<T, K>> {
...
// export const SnapshotProvider = <T extends  BaseData<T>, K extends T = T, Meta extends StructuredMetadata<T, K> = StructuredMetadata<T, K>>({
//   children,
// }: {
//   children: ReactNode;
// }) => {
...
//             const fetchSnapshot = <T extends  BaseData<T>, K extends T = T, Meta extends StructuredMetadata<T, K> = StructuredMetadata<T, K>>(
//               id: string
//             ): Promise<Snapshot<T, K>> => {
...
// function fetchSnapshotFromAPI<T extends  BaseData<T>, K extends T = T, Meta extends StructuredMetadata<T, K> = StructuredMetadata<T, K>>(
//   id: string
// ): Promise<Snapshot<T, K>> {
...
// function fetchSnapshotStoreFromAPI<T extends  BaseData<T>, K extends T = T, Meta extends StructuredMetadata<T, K> = StructuredMetadata<T, K>>(
//   id: string
// ): Promise<SnapshotStore<T, K>> {
//   return new Promise((resolve, reject) => {
//     // Wrapping async logic in a Promise
