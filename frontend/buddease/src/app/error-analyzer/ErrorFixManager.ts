...
import { TypeScriptErrorAnalyzer } from '@/app/error-analyzer/TypeScriptErrorAnalyzer';
import { TypeRelationshipAnalyzer } from '@/app/error-analyzer/TypeRelationshipAnalyzer';
import { FixPrioritizer } from '@/app/error-analyzer/FixPrioritizer';
import { FixConfidenceCalculator } from '@/app/error-analyzer/FixConfidenceCalculator';
import { CircularDependencyResolver } from '@/app/error-analyzer/CircularDependencyResolver';
import { ImportSuggestionGenerator } from '@/app/error-analyzer/ImportSuggestionGenerator';
import { FixVerifier } from '@/app/error-analyzer/FixVerifier';
import { ProgressTracker } from '@/app/error-analyzer/ProgressTracker';
import { ReportGenerator } from '@/app/error-analyzer/ReportGenerator';
