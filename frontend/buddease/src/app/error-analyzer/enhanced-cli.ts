...
import { FileRelationshipAnalyzer } from '@/app/error-analyzer/FileRelationshipAnalyzer';
import { ErrorFixManager } from '@/app/error-analyzer/ErrorFixManager';
import fs from 'fs';
import path from 'path';
import { execSync } from 'child_process';

// Add type definitions
import type { FixPlan } from '@/app/error-analyzer/ErrorFixManager';
