...
export class ImportErrorSummaryGenerator {
  ...
  private strategies: ImportFixStrategy[] = [
    ...
    {
      pattern: '^@/app/components/shared/SharedHeaders$',
    ...
    {
      pattern: '^@/ApiNote$',
      replacement: '@/app/api/ApiNote',
      description: 'Fix ApiNote import to use correct path',
      priority: 1,
      confidence: 0.9
    },
    {
      pattern: '^@/app/components/calendar/CalendarEventCollaborator$',
      replacement: '@/app/calendar/CalendarEventCollaborator',
      description: 'Fix calendar component import path',
      priority: 1,
      confidence: 0.9
    },
    {
      pattern: '^@/app/components/context/NotificationContext$',
      replacement: '@/app/context/NotificationContext',
      description: 'Fix context import path',
      priority: 1,
      confidence: 0.9
    },
    {
      pattern: '^@/app/security/AuthValidation$',
      replacement: '@/app/api/security/AuthValidation',
      description: 'Fix security import path',
      priority: 1,
      confidence: 0.8
    },
    {
      pattern: '^@/app/lib/server/database/DatabaseClient$',
      replacement: '@/app/api/DatabaseClient',
      description: 'Fix DatabaseClient import path',
      priority: 1,
      confidence: 0.9
    },
    {
      pattern: '^@/app/exchangeIntegrationServer$',
      replacement: '@/app/api/exchangeIntegrationServer',
      description: 'Fix exchange server import path',
      priority: 1,
      confidence: 0.9
    },
    {
      pattern: '^@/app/projects/DataAnalysisPhase/DataAnalysisActions$',
      replacement: '@/app/actions/DataAnalysisActions',
      description: 'Fix DataAnalysisActions import path',
      priority: 1,
      confidence: 0.8
    },
    {
      pattern: '^@/app/components/security/AuthValidation$',
      replacement: '@/app/api/security/AuthValidation',
    ...
    {
      pattern: '^@/app/components/server/generateComponent$',
      replacement: '@/app/api/generateComponent',
    ...
    },
    {
      ...
      replacement: '@/app/api/instances/createSharedSnapshotContainer',
    ...
    },
    {
      ...
      replacement: '@/app/models/PhaseEntity',
      description: 'Fix PhaseEntity import path',
      priority: 1,
      confidence: 0.8
    },
    {
      pattern: '^@/app/ApiPreferencesEndpoints$',
      replacement: '@/app/api/ApiPreferencesEndpoints',
      description: 'Fix ApiPreferencesEndpoints import path',
      priority: 1,
      confidence: 0.9
    },
    {
      pattern: '^@/app/components/communications/chat/ChatSettingsModal$',
      replacement: '@/app/components/communications/chat/ChatSettingsModal',
...
private importExists(resolvedPath: string): boolean {
  ...
  private determineSeverity(importPath: string): 'high' | 'medium' | 'low' {
    ...
    if (importPath.includes('@/utils/') ||
      ...
      importPath.includes('@/app/models/') ||
