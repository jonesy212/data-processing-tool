...
import { AuditEntry, BaseDataEntity, DefaultMeta } from '@/app/configs/ConfigurationService';
import { User } from '@/app/components/models/data/Data'; // Adjust import path as needed
