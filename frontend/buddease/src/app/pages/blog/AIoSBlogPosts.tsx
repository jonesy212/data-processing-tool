...
import BlogGenerator from '@/app/pages/blog/BlogGenerator'; // Assuming BlogGenerator is located in the same directory
 import BlogPostList from '@/app/pages/blog/BlogPosts';
