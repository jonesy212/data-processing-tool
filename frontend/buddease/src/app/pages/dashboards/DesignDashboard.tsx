...
import { Search } from "@/app/components/routing";
import ProtectedRoute from "@/app/components/routing/ProtectedRoute";
import RootSlice from "@/app/components/state/RootSlice";
import { AssignBaseStore } from "@/app/components/state_management";
...
import { UserService } from "@/app/components/users";
      ...
      <AdminDashboard apiConfig={{} as ApiConfig}>
        <div>
          ...
          <ModalGenerator
            ...
            modalComponent={<ConfirmationModal isOpen={false} onConfirm={function (): void {
              throw new Error("Function not implemented.");
            } } onCancel={function (): void {
              throw new Error("Function not implemented.");
            } }>Are you sure you want to close this modal?</ConfirmationModal>}
          />
        </div>
      </AdminDashboard>
