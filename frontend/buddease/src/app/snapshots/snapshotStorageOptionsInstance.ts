...
interface SnapshotStorageOptions<
 ...
 > {
	...
	initialState?: SnapshotStore<T, K, Meta, ExcludedFields> | Snapshot<T, K, Meta, AttachmentType, ExcludedFields, IncludedFields> | null; // Allows T and K to be distinct types
