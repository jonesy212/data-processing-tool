...
//               eventRecords: null,
//               getParentId: (childSnapshot: Snapshot<T, K, Meta, AttachmentType, ExcludedFields, IncludedFields>) => snapshot.getParentId(childSnapshot),
//               getChildIds: (id: string, childSnapshot: Snapshot<T, K, Meta, AttachmentType, ExcludedFields, IncludedFields>) => snapshot.getChildIds(childSnapshot),
//               addChild: (snapshot: Snapshot<T, K, Meta, AttachmentType, ExcludedFields, IncludedFields>) => snapshot.addChild(snapshot),
//               removeChild: (snapshot: Snapshot<T, K, Meta, AttachmentType, ExcludedFields, IncludedFields>) => snapshot.removeChild(snapshot),
//               getChildren: () => { },
//               hasChildren: () => false,
//               isDescendantOf: (snapshot: Snapshot<T, K, Meta, AttachmentType, ExcludedFields, IncludedFields>, childSnapshot: Snapshot<T, K, Meta, AttachmentType, ExcludedFields, IncludedFields>) => snapshot.isDescendantOf(snapshot, childSnapshot),
...
//               },
//               events: {
//                   callbacks: (snapshots:SnapshotsArray<T, K, Meta, AttachmentType, ExcludedFields, IncludedFields>) => {
