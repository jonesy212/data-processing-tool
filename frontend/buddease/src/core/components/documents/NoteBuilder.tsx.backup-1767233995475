// NoteBuilder.tsx
import { addNoteAPI, updateNoteAPI } from '@/core/api/ApiNote';
...
import { Change, NoteAttachment, NoteData, NoteOptions, NoteStatus, NoteVersion } from '@/core/documents/NoteData'; // Assuming you have a NoteData interface
