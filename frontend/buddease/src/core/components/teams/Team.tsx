...
import { Project, reassignProject } from "@/core/models/projects/Project";
...
import { TeamExcludedFields, TeamIncludedFields, TeamK } from '@/core/typings/entities/TeamEntity';
    ...
    TeamK,
    TeamMeta,
} from "@/core/typings/entities/TeamEntity";
...
const CommonDetails = dynamic(() => import("@/core/models/CommonData"), {
  ssr: false,
