...
import { initializeAppData } from '@/core/api/service/ApiService';
...
import type { defaultMetadata } from '@/core/layout';
import type { CacheReadOptions } from '@/core/libraries/cache/CacheResponse';
