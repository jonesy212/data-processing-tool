...
> extends CommonData<T, K, Meta, AttachmentType, ExcludedFields, IncludedFields> {
  ...
  dependency?: Dependency; // Phase IDs this phase depends on
...
> implements Phase<T, K, Meta, AttachmentType, ExcludedFields, IncludedFields> {
  ...
  relatedUsers?: string[];
  deadline?: Date | string;
  currentMeta: StructuredMetadata<T, K, Meta, AttachmentType, ExcludedFields, IncludedFields> = currentMeta;
  currentMetadata: UnifiedMetadata<T, K, Meta, AttachmentType, ExcludedFields, IncludedFields> = currentMetadata;
