...
import { fetchBugData } from '@/core/components/configs/ApiConfigComponent'; // Function to fetch bug data from API
...
import { usePagination } from '@/core/hooks/userInterface/usePagination';
