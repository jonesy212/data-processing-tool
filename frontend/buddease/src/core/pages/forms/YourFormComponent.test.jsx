...
// Mock external dependencies and context providersimport { useNotification } from '@/core/state/context/NotificationContext';
import { NotificationTypeEnum } from '@/core/features/support/UnifiedNotificationTypes'
import { useNotification } from "@/core/state/context/NotificationContext";


jest.mock('@/core/components/support/DynamicComponentsContext', () => ({
...
jest.mock('@/core/state/context/NotificationContext';, () => ({
  useNotification: jest.fn(() => ({
    notify: jest.fn(),
  })),
}));

jest.mock('@/core/pages/logging/Logger', () => ({
  logError: jest.fn(),
  logPageView: jest.fn(),
}));
