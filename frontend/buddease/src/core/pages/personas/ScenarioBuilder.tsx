// ScenarioBuilder.tsx
import { categorizeNews } from "@/core/components/community/articleKeywords";
...
import React from 'react';
    import { UserJourney } from '@/core/pages/personas/UserJourney';
...
function generateUserScenarioComponent(componentName: string, brand: any, userScenario: string): string {
  ...
  const userScenarioInterfaceCode = `
    import { UserScenario } from '@/core/components/UserScenario';
...
function generateUserJourneyMapComponent(componentName: string, brand: any, userJourneyData: any[]): string {
  ...
  const userJourneyMapComponentCode = `
    import { UserJourneyMap } from '@/core/components/UserJourneyMap'; // Import your journey map component
...
import { NewsItem } from '@/core/components/NewsItem';
...
function generateUserScenarioMapComponent(componentName: string, brand: any, userScenarioMapData: any[]): string {
  ...
  const userScenarioMapComponentCode = `
    import { UserScenarioMap } from '@/core/components/UserScenarioMap'; // Import your scenario map component
...
function generateDataVisualizationComponent(componentName: string, dataProperties: string[], chartType: string, brand: any) {
  ...
  return `
    ...
    import ChartComponent from "@/core/components/charts/ChartComponent"; // Import the ChartComponent
