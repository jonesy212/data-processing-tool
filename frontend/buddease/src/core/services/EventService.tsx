...
import { AppAttachment, AppEntity, AppExcludedFields, AppK, AppMeta } from '@/core/typings/entities/AppEntity';
import { EventAttachment, EventEntity, EventExcludedFields, EventIncludedFields, EventK, EventMeta } from '@/core/typings/entities/EventEntity';
...
interface CustomEventWithProperties<
...
export const createCustomEvent = (
  ...
  const customEvent: CustomEventWithProperties<AppEntity, AppK, AppMeta, AppAttachment, AppExcludedFields> = {
    id,
    title,
    description,
    startDate,
