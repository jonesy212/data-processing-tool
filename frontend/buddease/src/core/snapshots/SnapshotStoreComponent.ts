...
//   updateSnapshot(snapshot: Snapshot<T, K, Meta, AttachmentType, ExcludedFields, IncludedFields>): void {
//     if (!snapshot || !snapshot.id) {
//       throw new Error('Invalid snapshot data.');
//     }
...
//   getAllSnapshots(): Snapshot<T, K, Meta, AttachmentType, ExcludedFields, IncludedFields>[] {
//     return Array.from(this.snapshots.values());
//   }

//   // Method to trigger callbacks
//   private triggerCallbacks(event: string, snapshot: Snapshot<T, K, Meta, AttachmentType, ExcludedFields, IncludedFields>): void {
...
//   on(event: string, callback: Callback<Snapshot<T, K, Meta, AttachmentType, ExcludedFields, IncludedFields>>): void {
...
//   off(event: string, callback: Callback<Snapshot<T, K, Meta, AttachmentType, ExcludedFields, IncludedFields>>): void {
...
//     this.triggerCallbacks('clear', {} as Snapshot<T, K, Meta, AttachmentType, ExcludedFields, IncludedFields>); // Trigger clear event
//   }

//   // Method to find snapshots by a specific criterion
//   findSnapshotsByCriterion(predicate: (snapshot: Snapshot<T, K, Meta, AttachmentType, ExcludedFields, IncludedFields>) => boolean): Snapshot<T, K, Meta, AttachmentType, ExcludedFields, IncludedFields>[] {
//     return Array.from(this.snapshots.values()).filter(predicate);
//   }

//   // Method to sort snapshots
//   sortSnapshots(compareFn: (a: Snapshot<T, K, Meta, AttachmentType, ExcludedFields, IncludedFields>, b: Snapshot<T, K, Meta, AttachmentType, ExcludedFields, IncludedFields>) => number): Snapshot<T, K, Meta, AttachmentType, ExcludedFields, IncludedFields>[] {
//     return Array.from(this.snapshots.values()).sort(compareFn);
//   }

//   // Method to categorize snapshots
//   categorizeSnapshots(): Map<string, Snapshot<T, K, Meta, AttachmentType, ExcludedFields, IncludedFields>[]> {
//     const categories = new Map<string, Snapshot<T, K, Meta, AttachmentType, ExcludedFields, IncludedFields>[]>();
