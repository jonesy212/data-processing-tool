...
import CalendarEventEffectivenessEvaluation from '@/core/calendar/CalendarEventEffectivenessEvaluation';
import CalendarEventEngagementMetrics from '@/core/calendar/CalendarEventEngagementMetrics';
import CalendarEventFeedbackAnalysis from '@/core/calendar/CalendarEventFeedbackAnalysis';
import CalendarEventFollowUpActionSuggestion from '@/core/calendar/CalendarEventFollowUpActionSuggestion';
import CalendarEventImpactPrediction from '@/core/calendar/CalendarEventImpactPrediction';
import CalendarEventImprovement from '@/core/calendar/CalendarEventImprovement';
import { CalendarEventInvitationPersonalization } from '@/core/calendar/CalendarEventInvitationPersonalization';
import CalendarEventOptimizationRecommendation from '@/core/calendar/CalendarEventOptimizationRecommendation';
import CalendarEventOutcomeVariabilityPrediction from '@/core/calendar/CalendarEventOutcomeVariabilityPrediction';
import CalendarEventPriorityClassification from '@/core/calendar/CalendarEventPriorityClassification';
import CalendarEventRiskAssessment from '@/core/calendar/CalendarEventRiskAssessment';
import CalendarEventROIAnalysis from '@/core/calendar/CalendarEventROIAnalysis';
import CalendarEventSuccessPrediction from '@/core/calendar/CalendarEventSuccessPrediction';
import CalendarEventTimingOptimization from '@/core/calendar/CalendarEventTimingOptimization';
import CalendarEventTrendDetectionResult from '@/core/calendar/CalendarEventTrendDetectionResult';
import ExternalCalendarOverlay from '@/core/calendar/ExternalCalendarOverlay';
...
import EventCategory from '@/core/components/event/EventCategory';
import EventSentiment from '@/core/components/event/EventSentiment';
...
>() =>
  ...
  reducers: {
    ...
    milestones: (state, action: PayloadAction<Record<string, CalendarMilestone>>) => {
    ...
    addMilestone: (state, action: PayloadAction<CalendarMilestone>) => {
    ...
    removeMilestone: (state, action: PayloadAction<CalendarMilestone>) => {
      const milestones = state.milestones || {};
