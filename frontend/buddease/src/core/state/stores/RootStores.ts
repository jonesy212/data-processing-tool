// RootStores.ts
import { ApiManagerStore, useApiManagerStore } from '@/core/api/ApiStore';
import type { BaseDataEntity, DefaultExcludedFields, DefaultMeta } from '@/core/config/BaseConfig';
import type { Attachment } from '@/core/documents/attachment/Attachment';
import type { EventStore } from '@/core/events/EventStore';
import { globalCallbackRegistry } from '@/core/libraries/eventSystem/callbackRegistry';
import useUIStore from '@/core/libraries/ui/useUIStore';
import type { CalendarActionPayload, CalendarActionType } from '@/core/server/database/CalendarActionPayload';
import { useProjectManagerStore } from '@/core/state/hybrid/ProjectManagerStore';
import type {ProjectManagerStore } from '@/core/state/hybrid/ProjectManagerStore';
import { AppStore } from '@/core/state/stores/AppStore';
import { AuthorizationStore, useAuthorizationStore } from '@/core/state/stores/AuthorizationStore';
import { AuthStore, useAuthStore } from '@/core/state/stores/AuthStore';
...
import { useCollaborationStore } from '@/core/state/stores/CollaborationStore';
import type {CollaborationStore } from '@/core/state/stores/CollaborationStore';
import type { DataStore, useDataStore } from '@/core/state/stores/DataStore';
import type { DocumentStore } from '@/core/state/stores/DocumentStore';
import useDocumentStore from '@/core/state/stores/DocumentStore';
import type { IconStore } from '@/core/state/stores/IconStore';
import useIconStore from '@/core/state/stores/IconStore';
import NotificationStore from '@/core/state/stores/NotificationStore';

import type { SettingManagerStore } from '@/core/state/hybrid/SettingsManagerStore';
...
import type { TeamManagerStore } from '@/core/state/stores/TeamStore';
...
import { ToolbarStore, useToolbarStore } from '@/core/state/stores/ToolbarStore';
...
import type { UndoRedoStore } from '@/core/state/stores/UndoRedoStore';
import { userManagerStore } from '@/core/state/stores/UserStore';
import type { UserStore } from '@/core/state/stores/UserStore';
import type { VideoStore } from '@/core/state/stores/VideoStore';
