...
import { SubscriberAttachment, SubscriberEntity, SubscriberExcludedFields, SubscriberIncludedFields, SubscriberK, SubscriberMeta } from '@/core/typings/entities/SubscriberEntity';
...
>(
  ...
  return {
    ...
    // Include all required properties from SnapshotStoreConfig
    id: "config-id",
    storeId: snapshotStore.storeId,
    find: snapshotStore.find,
    configId: "default-config-id",
    getSnapshotManager: () => snapshotStore.snapshotManager,
    callback: () => {},
    isCore: true,
