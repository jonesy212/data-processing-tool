...
export interface UiSettingsEndpoints extends EndpointCategoryConfig {
  ...
  // UI-Specific Settings & Interface Content
  fetchInterfaceContent: () => EndpointConfig;
  updateInterfaceSettings: () => EndpointConfig;
  fetchUserDashboard: (userId: string) => EndpointConfig;
  updateUserDashboardLayout: (userId: string) => EndpointConfig;
  fetchUserWidgets: (userId: string) => EndpointConfig;
  customizeUserWidget: (userId: string, widgetId: string) => EndpointConfig;
  fetchUserThemes: (userId: string) => EndpointConfig;
  switchUserTheme: (userId: string, themeId: string) => EndpointConfig;
  fetchUserPreferences: (userId: string) => EndpointConfig;
  fetchUserNotifications: (userId: string) => EndpointConfig;
  markNotificationAsRead: (userId: string, notificationId: string) => EndpointConfig;
  clearAllNotifications: (userId: string) => EndpointConfig;
  fetchUserMessages: (userId: string) => EndpointConfig;
  sendMessageToUser: (userId: string, messageId: string) => EndpointConfig;
  toggleDarkMode: (userId: string) => EndpointConfig;
  fetchUserAvatar: (userId: string) => EndpointConfig;
  updateUserAvatar: (userId: string) => EndpointConfig;
  fetchUserSettings: (userId: string) => EndpointConfig;
