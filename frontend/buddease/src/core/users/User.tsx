// User.tsx
// import type { NotificationPreferences } from "@/core/cards/modal/ChatSettingsModal";
// import type { RealtimeUpdates } from "@/core/components/community/ActivityFeedComponent";
...
import type { ProfileAccessControl } from "@/core/pages/profile/Profile";
...
import type { TwitterData } from "@/core/socialMedia/TwitterIntegration";
import type { ActivityLogEntry } from "@/core/state/redux/slices/UserSlice";
import type { Subscription } from '@/core/subscriptions/Subscription';
import type { DataProcessingTask } from "@/core/todos/tasks/DataProcessingTask";
import type { BlockchainAsset } from '@/core/typings/cryptoTypes/BlockchainAsset';
import type {
    CustomTransaction,
...
import type { UserProfileDetails } from '@/core/typings/userTypes';
import { createLatestVersion } from '@/core/versions/createLatestVersion';
import type { SharedVersionData } from "@/core/versions/VersionData";
import React from "react";

import type { UserRole } from "@/core/models/UserRole";
import UserRoles from "@/core/models/UserRoles";
import type { BlockchainPermissions } from "@/core/permissions/BlockchainPermissions";
import type { SocialLinks } from "@/core/users/SocialLinks";
