...
import type { CommonRelationship, SharedRelationshipData } from '@/core/models/data/Data';
...
import type { DAppAdapterProps } from '@/utils/web3/crossPlatformLayer/platform/DAppAdapter';
